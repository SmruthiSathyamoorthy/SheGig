<%-- 
    Document   : contact
    Created on : 22 Apr, 2020, 5:16:07 PM
      ...
      <div class="container">
          ...
          <div class="row">
              ...
              <div class="col-md-6 mt-3 contact-widget-section2 wow animated fadeInLeft" data-wow-delay=".2s">
                <p>We appreciate any problems or concerns. Write to us, and our staff will reach you at your email address within 24 hours of time. Feedback and suggestions are also welcome.  

                <div class="find-widget">
                 Company:  <a href="https://hostriver.ro">Shegig</a>
                </div>
                <div class="find-widget">
                 Address: <a href="#">Anna University, Sardar Patel Road, Guindy, Chennai, Tamil Nadu 600015</a>
                </div>
                <div class="find-widget">
                ...
                <div class="find-widget">
                  email:  <a href="https://uny.ro">contactus@shegig.com</a>
                </div>
                <div class="find-widget">
                   Working Hours: <a href="#">Mon to Sat: 09:30 AM - 10.30 PM</a>
                </div>
              </div>
              <!-- contact form -->
